...
use fake_tcp::{ObfuscateConfig, PayloadPaddingConfig, ServerHandshakeConfig, Stack};
...
async fn main() -> io::Result<()> {
    ...
    let mut stack = Stack::new_with_config(tun, tun_local, tun_local6, payload_padding, obfuscate);
